;; Taken from http://github.com/rexim/gruber-darker-theme
...
(let ((gruber-darker-fg        "#e4e4ef")
  ...
  (custom-theme-set-faces
   ...
   `(compilation-warning ((t (:foreground ,gruber-darker-brown :bold t :inherit unspecified))))
   ...
   ;; Diff
   `(diff-removed ((t (:foreground ,gruber-darker-red+1 :background unspecified))))
   `(diff-added ((t (:foreground ,gruber-darker-green :background unspecified))))

   ;; Dired
   `(dired-directory ((t (:foreground ,gruber-darker-niagara :weight bold))))
   `(dired-ignored ((t (:foreground ,gruber-darker-quartz :inherit unspecified))))
   ...
   ;; Consult
   `(consult-line-number-wrapped ((t (:inherit 'consult-line-number))))
   ))
