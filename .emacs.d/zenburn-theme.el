...
(zenburn-with-color-variables
  (custom-theme-set-faces 'zenburn
    ...
    (link
      (
        (,class
          (:foreground ,zenburn-yellow :underline t :weight bold))))
    `
    (link-visited
      (
        (,class
    ...
    `
    (default
      ((,class (:foreground ,zenburn-fg :background ,zenburn-bg))))
    `
    (cursor
      ((,class (:foreground ,zenburn-fg :background ,zenburn-fg+1))))
    `
    (widget-field
    ...
    `
    (fringe
      ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+1))))
    `
    (header-line
      (
        (,class
    ...
    `
    (ansi-color-black
      ((,class (:foreground ,zenburn-bg :background ,zenburn-bg-1))))
    `
    (ansi-color-red
      (
        (,class
          (:foreground ,zenburn-red-2 :background ,zenburn-red-4))))
    `
    (ansi-color-green
      (
        (,class
          (:foreground ,zenburn-green :background ,zenburn-green+2))))
    `
    (ansi-color-yellow
      (
        (,class
          (:foreground ,zenburn-orange :background ,zenburn-yellow))))
    `
    (ansi-color-blue
      (
        (,class
          (:foreground ,zenburn-blue-1 :background ,zenburn-blue-4))))
    `
    (ansi-color-magenta
      (
        (,class
          (:foreground ,zenburn-magenta :background ,zenburn-red))))
    `
    (ansi-color-cyan
      (
        (,class
          (:foreground ,zenburn-cyan :background ,zenburn-blue))))
    `
    (ansi-color-white
      ((,class (:foreground ,zenburn-fg :background ,zenburn-fg-1))))
    ;;;;; compilation
    ...
    (compilation-warning-face
      (
        (,class
          (:foreground ,zenburn-orange :weight bold :underline t))))
    `
    (compilation-mode-line-exit
      ((,class (:foreground ,zenburn-green+2 :weight bold))))
    `
    (compilation-mode-line-fail
      ((,class (:foreground ,zenburn-red :weight bold))))
    `
    ...
    `
    (custom-variable-tag
      ((,class (:foreground ,zenburn-blue :weight bold))))
    `
    (custom-group-tag
      (
        (,class
          (:foreground ,zenburn-blue :weight bold :height 1.2))))
    `(custom-state ((,class (:foreground ,zenburn-green+4))))
    ;;;;; display-fill-column-indicator
    `
    (fill-column-indicator
      ((,class :foreground ,zenburn-bg-05 :weight semilight)))
    ;;;;; eww
    ...
    (hi-blue
      (
        (,class
          (:background ,zenburn-cyan :foreground ,zenburn-bg-1))))
    `
    (hi-green
      (
        (,class
          (:background ,zenburn-green+4 :foreground ,zenburn-bg-1))))
    `
    (hi-pink
      (
        (,class
          (:background ,zenburn-magenta :foreground ,zenburn-bg-1))))
    `
    (hi-yellow
      (
        (,class
          (:background ,zenburn-yellow :foreground ,zenburn-bg-1))))
    ...
    (isearch-fail
      (
        (,class
          (:foreground ,zenburn-fg :background ,zenburn-red-4))))
    `
    (lazy-highlight
      (
        (,class
    ...
    `
    (region
      ((,class (:background ,zenburn-bg-1 :extend t))
        (t :inverse-video t)))
    ...
    (font-lock-builtin-face
      ((,class (:foreground ,zenburn-fg :weight bold))))
    ...
    (line-number-current-line
      (
        (,class
          (:inherit line-number :foreground ,zenburn-yellow-2))))
    ;;;;; man
    ...
    (newsticker-extra-face
      ((,class (:foreground ,zenburn-bg+2 :height 0.8))))
    ...
    (newsticker-treeview-old-face
      ((,class (:foreground ,zenburn-bg+3))))
    `
    (newsticker-treeview-selection-face
      (
        (,class
          (:background ,zenburn-bg-1 :foreground ,zenburn-yellow))))
    ;;;;; woman
    ...
    `
    (diff-added
      ((,class (:background "#335533" :foreground ,zenburn-green))))
    `
    (diff-changed
      (
        (,class
          (:background "#555511" :foreground ,zenburn-yellow-1))))
    `
    (diff-removed
      ((,class (:background "#553333" :foreground ,zenburn-red-2))))
    `
    (diff-refine-added
      (
        (,class
          (:background "#338833" :foreground ,zenburn-green+4))))
    `
    (diff-refine-changed
      ((,class (:background "#888811" :foreground ,zenburn-yellow))))
    `
    (diff-refine-removed
      ((,class (:background "#883333" :foreground ,zenburn-red))))
    `
    (diff-header
      ((,class (:background ,zenburn-bg+2))
    ...
    (diff-hl-change
      (
        (,class
          (:foreground ,zenburn-blue :background ,zenburn-blue-2))))
    `
    (diff-hl-delete
      (
        (,class
          (:foreground ,zenburn-red+1 :background ,zenburn-red-1))))
    `
    (diff-hl-insert
      (
        (,class
    ...
    (diredp-dir-heading
      (
        (,class
          (:foreground ,zenburn-blue :background ,zenburn-bg-1))))
    ...
    (ediff-current-diff-B
      (
        (,class
          (:foreground ,zenburn-fg :background ,zenburn-green-2))))
    `
    (ediff-current-diff-C
      (
        (,class
          (:foreground ,zenburn-fg :background ,zenburn-blue-5))))
    ...
    (w3m-lnum
      (
        (,class
          (:foreground ,zenburn-green+2 :background ,zenburn-bg))))
    `
    (w3m-lnum-match
      (
        (,class
    ...
    `
    (eshell-ls-archive
      ((,class (:foreground ,zenburn-red-1 :weight bold))))
    `(eshell-ls-backup ((,class (:inherit font-lock-comment-face))))
    `(eshell-ls-clutter ((,class (:inherit font-lock-comment-face))))
    `
    (eshell-ls-directory
      ((,class (:foreground ,zenburn-blue+1 :weight bold))))
    `
    ...
    `
    (eshell-ls-symlink
      ((,class (:foreground ,zenburn-cyan :weight bold))))
    ;;;;; flycheck
    `
    (flycheck-error
      (
        (((supports :underline (:style wave)))
          (:underline
            (:style wave :color ,zenburn-red-1)
            :inherit unspecified))
    ...
    (flycheck-warning
      (
        (((supports :underline (:style wave)))
          (:underline
            (:style wave :color ,zenburn-yellow)
            :inherit unspecified))
    ...
    (flymake-warnline
      (
        (((supports :underline (:style wave)))
          (:underline
            (:style wave :color ,zenburn-orange)
            :inherit unspecified
            :foreground unspecified
            :background unspecified))
    ...
    (flymake-infoline
      (
        (((supports :underline (:style wave)))
          (:underline
            (:style wave :color ,zenburn-green)
            :inherit unspecified
            :foreground unspecified
            :background unspecified))
    ...
    (git-commit-comment-action
      ((,class (:foreground ,zenburn-green+1 :weight bold))))
    `
    (git-commit-comment-branch
      ((,class (:foreground ,zenburn-blue+1 :weight bold)))) ; obsolete
    `
    ...
    (git-gutter:deleted
      (
        (,class
          (:foreground ,zenburn-red :weight bold :inverse-video t))))
    `
    (git-gutter:modified
      (
        (,class
    ...
    (git-gutter:unchanged
      (
        (,class
          (:foreground ,zenburn-fg :weight bold :inverse-video t))))
    ;;;;; git-gutter-fr
    `
    (git-gutter-fr:added
      ((,class (:foreground ,zenburn-green :weight bold))))
    ...
    (git-gutter-fr:modified
      ((,class (:foreground ,zenburn-magenta :weight bold))))
    ;;;;; git-rebase
    `(git-rebase-hash ((,class (:foreground, zenburn-orange))))
    ;;;;; gnus
    `
    (gnus-group-mail-1
      ((,class (:weight bold :inherit gnus-group-mail-1-empty))))
    `
    (gnus-group-mail-1-empty
      ((,class (:inherit gnus-group-news-1-empty))))
    `
    (gnus-group-mail-2
      ((,class (:weight bold :inherit gnus-group-mail-2-empty))))
    `
    (gnus-group-mail-2-empty
      ((,class (:inherit gnus-group-news-2-empty))))
    `
    (gnus-group-mail-3
      ((,class (:weight bold :inherit gnus-group-mail-3-empty))))
    `
    (gnus-group-mail-3-empty
      ((,class (:inherit gnus-group-news-3-empty))))
    `
    (gnus-group-mail-4
      ((,class (:weight bold :inherit gnus-group-mail-4-empty))))
    `
    (gnus-group-mail-4-empty
      ((,class (:inherit gnus-group-news-4-empty))))
    `
    (gnus-group-mail-5
      ((,class (:weight bold :inherit gnus-group-mail-5-empty))))
    `
    (gnus-group-mail-5-empty
      ((,class (:inherit gnus-group-news-5-empty))))
    `
    (gnus-group-mail-6
      ((,class (:weight bold :inherit gnus-group-mail-6-empty))))
    `
    (gnus-group-mail-6-empty
      ((,class (:inherit gnus-group-news-6-empty))))
    `
    (gnus-group-mail-low
      ((,class (:weight bold :inherit gnus-group-mail-low-empty))))
    `
    (gnus-group-mail-low-empty
      ((,class (:inherit gnus-group-news-low-empty))))
    `
    (gnus-group-news-1
      ((,class (:weight bold :inherit gnus-group-news-1-empty))))
    `
    (gnus-group-news-2
      ((,class (:weight bold :inherit gnus-group-news-2-empty))))
    `
    (gnus-group-news-3
      ((,class (:weight bold :inherit gnus-group-news-3-empty))))
    `
    (gnus-group-news-4
      ((,class (:weight bold :inherit gnus-group-news-4-empty))))
    `
    (gnus-group-news-5
      ((,class (:weight bold :inherit gnus-group-news-5-empty))))
    `
    (gnus-group-news-6
      ((,class (:weight bold :inherit gnus-group-news-6-empty))))
    `
    (gnus-group-news-low
      ((,class (:weight bold :inherit gnus-group-news-low-empty))))
    ...
    `
    (gnus-server-closed
      ((,class (:foreground ,zenburn-blue :slant italic))))
    `
    (gnus-server-offline
      ((,class (:foreground ,zenburn-yellow :weight bold))))
    `
    ...
    (gnus-group-news-4-empty
      ((,class (:foreground ,zenburn-blue-2))))
    `
    (gnus-group-news-5-empty
      ((,class (:foreground ,zenburn-blue-3))))
    ...
    `
    (gnus-x
      ((,class (:background ,zenburn-fg :foreground ,zenburn-bg))))
    `
    (mm-uu-extract
      (
        (,class
          (:background ,zenburn-bg-05 :foreground ,zenburn-green+1))))
    ;;;;; highlight-numbers
    ...
    `
    (hl-line-face
      ((,class (:background ,zenburn-bg-05)) (t :weight bold)))
    `
    (hl-line
      ((,class (:background ,zenburn-bg-05 :extend t)) ; old emacsen
        (t :weight bold)))
    ;;;;; hl-sexp
    `
    (hl-sexp-face
      ((,class (:background ,zenburn-bg+1)) (t :weight bold)))
    ;;;;; corfu
    `
    (corfu-default
      ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+1))))
    ...
    (ido-indicator
      (
        (,class
          (:foreground ,zenburn-yellow :background ,zenburn-red-4))))
    ;;;;; iedit-mode
    `
    (iedit-occurrence
      ((,class (:background ,zenburn-bg+2 :weight bold))))
    ;;;; js2-mode
    ...
    `
    (lispy-cursor-face
      ((,class (:foreground ,zenburn-bg :background ,zenburn-fg))))
    `
    (lispy-face-hint
      ((,class (:inherit highlight :foreground ,zenburn-yellow))))
    ;;;;; ruler-mode
    `
    (ruler-mode-column-number
      (
        (,class
          (:inherit 'ruler-mode-default :foreground ,zenburn-fg))))
    `
    ...
    (ruler-mode-current-column
      ((,class (:foreground ,zenburn-yellow :box t))))
    `
    (ruler-mode-default
      (
        (,class
    ...
    (magit-diff-file-heading-highlight
      ((,class (:background ,zenburn-bg+05 :weight bold))))
    `
    ...
    (magit-diff-added-highlight
      ((,class (:background ,zenburn-green))))
    `(magit-diff-removed ((,class (:background ,zenburn-red-4))))
    `
    (magit-diff-removed-highlight
      ((,class (:background ,zenburn-red-3))))
    ...
    (magit-diff-hunk-heading-selection
      (
        (,class
          (:background ,zenburn-bg+2 :foreground ,zenburn-orange))))
    `
    (magit-diff-lines-heading
      (
        (,class
          (:background ,zenburn-orange :foreground ,zenburn-bg+2))))
    `
    (magit-diff-context-highlight
      ((,class (:background ,zenburn-bg+05 :foreground "grey70"))))
    ...
    (magit-popup-disabled-argument
      ((,class (:foreground ,zenburn-fg-1 :weight normal))))
    `
    (magit-popup-option-value
      ((,class (:foreground ,zenburn-blue-2 :weight bold))))
    ;;;;;; process
    `
    (magit-process-ok
      ((,class (:foreground ,zenburn-green :weight bold))))
    ...
    (magit-blame-heading
      (
        (,class
          (:background ,zenburn-bg-1 :foreground ,zenburn-blue-2))))
    `
    (magit-blame-hash
      (
        (,class
    ...
    (magit-blame-name
      (
        (,class
          (:background ,zenburn-bg-1 :foreground ,zenburn-orange))))
    `
    (magit-blame-date
      (
        (,class
    ...
    (magit-branch-current
      ((,class (:foreground ,zenburn-blue :weight bold :box t))))
    ...
    (magit-signature-revoked
      ((,class (:foreground ,zenburn-magenta))))
    ...
    (markup-internal-reference-face
      ((,class (:foreground ,zenburn-yellow-2 :underline t))))
    ...
    (markup-secondary-text-face
      ((,class (:foreground ,zenburn-yellow-1))))
    `
    (markup-title-0-face
      (
        (,class
    ...
    `
    (mu4e-cited-2-face
      ((,class (:foreground ,zenburn-green+2 :slant italic))))
    `
    (mu4e-cited-3-face
      ((,class (:foreground ,zenburn-blue-2 :slant italic))))
    `
    (mu4e-cited-4-face
      ((,class (:foreground ,zenburn-green :slant italic))))
    `
    (mu4e-cited-5-face
      ((,class (:foreground ,zenburn-blue-4 :slant italic))))
    `
    (mu4e-cited-6-face
      ((,class (:foreground ,zenburn-green-2 :slant italic))))
    `
    ...
    `
    (mu4e-trashed-face
      ((,class (:foreground ,zenburn-bg+3 :strike-through t))))
    ;;;;; orderless
    ...
    (org-agenda-date-today
      (
        (,class
          (:foreground ,zenburn-fg+1 :slant italic :weight bold)))
      t)
    `
    ...
    (org-done
      (
        (,class
          (:weight bold :weight bold :foreground ,zenburn-green+3))))
    ...
    (org-level-5
      (
        (,class
          (:inherit ,z-variable-pitch :foreground ,zenburn-cyan))))
    `
    (org-level-6
      (
        (,class
          (:inherit ,z-variable-pitch :foreground ,zenburn-green+2))))
    `
    (org-level-7
      (
        (,class
          (:inherit ,z-variable-pitch :foreground ,zenburn-red+2))))
    `
    (org-level-8
      (
        (,class
          (:inherit ,z-variable-pitch :foreground ,zenburn-magenta))))
    `
    (org-link
      ((,class (:foreground ,zenburn-yellow-2 :underline t))))
    ...
    `
    (org-sexp-date
      ((,class (:foreground ,zenburn-blue+1 :underline t))))
    `
    (org-special-keyword
      ((,class (:inherit font-lock-comment-face))))
    ...
    (org-todo
      (
        (,class
          (:weight bold :foreground ,zenburn-red :weight bold))))
    `
    ...
    (org-column-title
      (
        (,class
          (:background ,zenburn-bg-1 :underline t :weight bold))))
    `
    (org-mode-line-clock
      ((,class (:foreground ,zenburn-fg :background ,zenburn-bg-1))))
    `
    (org-mode-line-clock-overrun
      (
        (,class
          (:foreground ,zenburn-bg :background ,zenburn-red-1))))
    `
    (org-ellipsis
      ((,class (:foreground ,zenburn-yellow-1 :underline t))))
    `
    (org-footnote
      ((,class (:foreground ,zenburn-cyan :underline t))))
    `
    (org-document-title
      (
        (,class
    ...
    (org-habit-clear-future-face
      ((,class :background ,zenburn-blue-4)))
    `
    (org-habit-ready-future-face
      ((,class :background ,zenburn-green-2)))
    `
    ...
    (org-habit-overdue-future-face
      ((,class :background ,zenburn-red-4)))
    ;;;;; org-ref
    ...
    (outline-7
      (
        (,class
          (:inherit ,z-variable-pitch :foreground ,zenburn-red-4))))
    `
    (outline-8
      (
        (,class
          (:inherit ,z-variable-pitch :foreground ,zenburn-blue-4))))
    ;;;;; c/perl
    `
    ...
    (cperl-array-face
      (
        (,class
          (:foreground ,zenburn-yellow, :background ,zenburn-bg))))
    `
    (cperl-hash-face
      (
        (,class
          (:foreground ,zenburn-yellow-1, :background ,zenburn-bg))))
    ;;;;; paren-face
    ...
    `
    (powerline-active1
      ((,class (:background ,zenburn-bg-05 :inherit mode-line))))
    `
    (powerline-active2
      ((,class (:background ,zenburn-bg+2 :inherit mode-line))))
    `
    (powerline-inactive1
      (
        (,class
          (:background ,zenburn-bg+1 :inherit mode-line-inactive))))
    `
    (powerline-inactive2
      (
        (,class
          (:background ,zenburn-bg+3 :inherit mode-line-inactive))))
    ;;;;; re-builder
    `
    (reb-match-0
      (
        (,class
          (:foreground ,zenburn-bg :background ,zenburn-magenta))))
    `
    (reb-match-1
      ((,class (:foreground ,zenburn-bg :background ,zenburn-blue))))
    `
    (reb-match-2
      (
        (,class
          (:foreground ,zenburn-bg :background ,zenburn-orange))))
    `
    (reb-match-3
      ((,class (:foreground ,zenburn-bg :background ,zenburn-red))))
    ;;;;; rmail
    `
    (rmail-highlight
      ((,class (:foreground ,zenburn-yellow :weight bold))))
    ...
    `
    (sml/minor-modes
      ((,class (:foreground ,zenburn-fg-1 :weight bold))))
    `
    (sml/filename
      ((,class (:foreground ,zenburn-yellow :weight bold))))
    `
    ...
    (sp-show-pair-match-face
      ((,class (:background ,zenburn-bg+3 :weight bold))))
    ;;;;; sml-mode-line
    `
    ...
    (web-mode-css-pseudo-class-face
      ((,class (:foreground ,zenburn-green+3 :weight bold))))
    ...
    (whitespace-space
      (
        (,class
          (:background ,zenburn-bg+1 :foreground ,zenburn-bg+1))))
    `
    (whitespace-hspace
      (
        (,class
    ...
    (whitespace-line
      (
        (,class
          (:background ,zenburn-bg :foreground ,zenburn-magenta))))
    `
    (whitespace-space-before-tab
      (
        (,class
          (:background ,zenburn-orange :foreground ,zenburn-orange))))
    `
    (whitespace-indentation
      (
        (,class
          (:background ,zenburn-yellow :foreground ,zenburn-red))))
    ...
    (unless zenburn-colors-font-lock-keywords
      (setq zenburn-colors-font-lock-keywords
        ...
        (
          (
            ,
            (regexp-opt (mapcar 'car zenburn-default-colors-alist)
              'words)
            (0
              (rainbow-colorize-by-assoc
                zenburn-default-colors-alist))))))
