...
;; A port of the popular Vim theme Zenburn for Emacs.

;;; Credits:

;; Taken from https://github.com/bbatsov/zenburn-emacs.
...
(defgroup zenburn-theme nil
  ...
  :group 'faces
  :prefix "zenburn-"
  :link '(url-link :tag "GitHub" "http://github.com/NumericalGandalf/dotfiles")
  :tag "Zenburn theme")
...
defining them in this alist."
  :group 'zenburn-theme
  :type '(alist :key-type (string :tag "Name") :value-type (string :tag " Hex")))
...
(defvar zenburn-default-colors-alist '(("zenburn-fg-1"     . "#656555")
...
Also bind `class' to ((class color) (min-colors 89))."
  ...
  `(let ((class '((type graphic)))
         ...
         (z-variable-pitch (if zenburn-use-variable-pitch 'variable-pitch 'default)))
     ,@body))
...
;;;;; basic coloring
   ...
   `(header-line ((,class (:foreground ,zenburn-yellow :background ,zenburn-bg-1 :extend t))))
   ...
   `(homoglyph ((,class (:foreground ,zenburn-cyan))))
;;;;; ansi-colors
   `(ansi-color-black ((,class (:foreground ,zenburn-bg :background ,zenburn-bg-1))))
   `(ansi-color-red ((,class (:foreground ,zenburn-red-2 :background ,zenburn-red-4))))
   `(ansi-color-green ((,class (:foreground ,zenburn-green :background ,zenburn-green+2))))
   `(ansi-color-yellow ((,class (:foreground ,zenburn-orange :background ,zenburn-yellow))))
   `(ansi-color-blue ((,class (:foreground ,zenburn-blue-1 :background ,zenburn-blue-4))))
   `(ansi-color-magenta ((,class (:foreground ,zenburn-magenta :background ,zenburn-red))))
   `(ansi-color-cyan ((,class (:foreground ,zenburn-cyan :background ,zenburn-blue))))
   `(ansi-color-white ((,class (:foreground ,zenburn-fg :background ,zenburn-fg-1))))
;;;;; compilation
...
;;;;; isearch
   ...
   `(mode-line ((,class (:foreground ,zenburn-green+1 :background ,zenburn-bg-1))))
   `(mode-line-buffer-id ((,class (:foreground ,zenburn-yellow :weight bold))))
   `(mode-line-inactive ((,class (:foreground ,zenburn-green-2 :background ,zenburn-bg-05))))
...
;;;;; font lock
   ...
   `(font-lock-builtin-face ((,class (:inherit ,font-lock-function-name-face))))
...
;;;;; line numbers (Emacs 26.1 and above)
   `(line-number ((,class (:inherit default :foreground ,zenburn-bg+3 :slant italic))))
   `(line-number-current-line ((,class (:inherit line-number :foreground ,zenburn-yellow-1))))
;;;;; man
...
;;;;; ace-jump
   `(ace-jump-face-background ((,class (:foreground ,zenburn-fg-1 :background ,zenburn-bg :inverse-video nil))))
   `(ace-jump-face-foreground ((,class (:foreground ,zenburn-green+2 :background ,zenburn-bg :inverse-video nil))))
;;;;; ace-window
   `(aw-background-face ((,class (:foreground ,zenburn-fg-1 :background ,zenburn-bg :inverse-video nil))))
...
;;;;; avy
   `(avy-background-face ((,class (:foreground ,zenburn-fg-1 :background ,zenburn-bg :inverse-video nil))))
   `(avy-lead-face-0 ((,class (:foreground ,zenburn-green+3 :background ,zenburn-bg :inverse-video nil :weight bold))))
   `(avy-lead-face-1 ((,class (:foreground ,zenburn-yellow :background ,zenburn-bg :inverse-video nil :weight bold))))
   `(avy-lead-face-2 ((,class (:foreground ,zenburn-red+1 :background ,zenburn-bg :inverse-video nil :weight bold))))
   `(avy-lead-face ((,class (:foreground ,zenburn-cyan :background ,zenburn-bg :inverse-video nil :weight bold))))
;;;;; company-mode
   ...
   `(company-preview ((,class (:background ,zenburn-bg-05 :underline t))))
...
;;;;; centaur-tabs
   `(centaur-tabs-default ((,class (:background ,zenburn-bg :foreground ,zenburn-fg))))
   `(centaur-tabs-selected ((,class (:background ,zenburn-bg :foreground ,zenburn-fg+2))))
   `(centaur-tabs-unselected ((,class (:background ,zenburn-bg-1 :foreground ,zenburn-fg-05))))
   `(centaur-tabs-selected-modified ((,class (:background ,zenburn-bg :foreground ,zenburn-orange))))
   `(centaur-tabs-unselected-modified ((,class (:background ,zenburn-bg-1 :foreground ,zenburn-orange))))
   `(centaur-tabs-active-bar-face ((,class (:background ,zenburn-yellow :box nil))))
   `(centaur-tabs-modified-marker-selected ((,class (:inherit 'centaur-tabs-selected-modified :foreground ,zenburn-yellow))))
   `(centaur-tabs-modified-marker-unselected ((,class (:inherit 'centaur-tabs-unselected-modified :foreground ,zenburn-yellow))))
;;;;; cider
...
;;;;; flycheck
   `(flycheck-error ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-red-1) :inherit unspecified))))
   `(flycheck-warning ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-yellow) :inherit unspecified))))
   `(flycheck-info ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-cyan) :inherit unspecified))))
...
;;;;; flymake
   `(flymake-errline ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-red) :inherit unspecified :foreground unspecified :background unspecified))))
   `(flymake-warnline ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-orange) :inherit unspecified :foreground unspecified :background unspecified))))
   `(flymake-infoline ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-green) :inherit unspecified :foreground unspecified :background unspecified))))
   `(flymake-error ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-red) :inherit unspecified :foreground unspecified :background unspecified))))
   `(flymake-warning ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-orange) :inherit unspecified :foreground unspecified :background unspecified))))
   `(flymake-note ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-green) :inherit unspecified :foreground unspecified :background unspecified))))
;;;;; flyspell
   `(flyspell-duplicate ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-orange) :inherit unspecified))))
   `(flyspell-incorrect ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-red) :inherit unspecified))))
;;;;; full-ack
...
;;;;; helm
   `(helm-header ((,class (:foreground ,zenburn-green :background ,zenburn-bg :underline nil :extend t))))
   `(helm-source-header ((,class (:foreground ,zenburn-yellow :background ,zenburn-bg-1 :underline nil :weight bold :extend t))))
...
;;;;; macrostep
   `(macrostep-gensym-1 ((,class (:foreground ,zenburn-green+2 :background ,zenburn-bg-1))))
   `(macrostep-gensym-2 ((,class (:foreground ,zenburn-red+1 :background ,zenburn-bg-1))))
   `(macrostep-gensym-3 ((,class (:foreground ,zenburn-blue+1 :background ,zenburn-bg-1))))
   `(macrostep-gensym-4 ((,class (:foreground ,zenburn-magenta :background ,zenburn-bg-1))))
   `(macrostep-gensym-5 ((,class (:foreground ,zenburn-yellow :background ,zenburn-bg-1))))
   `(macrostep-expansion-highlight-face ((,class (:inherit highlight))))
   `(macrostep-macro-face ((,class (:underline t))))
;;;;; magit
;;;;;; headings and diffs
   ;; Please read (info "(magit)Theming Faces") before changing this.
...
;;;;;; blame
   ...
   `(magit-blame-summary ((,class (:background ,zenburn-bg-1 :foreground ,zenburn-blue-2 :weight bold))))
;;;;;; references etc
...
;;;;; merlin
   ...
   `(merlin-compilation-warning-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-orange)))))
   `(merlin-compilation-error-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-red)))))
;;;;; mu4e
...
;;;;; org-mode
   `(org-agenda-date-today ((,class (:foreground ,zenburn-fg+1 :slant italic :weight bold))) t)
   ...
   `(org-level-1 ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-orange ,@(when zenburn-scale-org-headlines (list :height zenburn-height-plus-4))))))
   `(org-level-2 ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-green+4 ,@(when zenburn-scale-org-headlines (list :height zenburn-height-plus-3))))))
   `(org-level-3 ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-blue-1 ,@(when zenburn-scale-org-headlines (list :height zenburn-height-plus-2))))))
   `(org-level-4 ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-yellow-2 ,@(when zenburn-scale-org-headlines (list :height zenburn-height-plus-1))))))
   ...
   `(org-document-title ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-blue :weight bold ,@(when zenburn-scale-org-headlines (list :height zenburn-height-plus-4))))))
...
;;;;; outline
   `(outline-1 ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-orange ,@(when zenburn-scale-outline-headlines (list :height zenburn-height-plus-4))))))
   `(outline-2 ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-green+4 ,@(when zenburn-scale-outline-headlines (list :height zenburn-height-plus-3))))))
   `(outline-3 ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-blue-1 ,@(when zenburn-scale-outline-headlines (list :height zenburn-height-plus-2))))))
   `(outline-4 ((,class (:inherit ,z-variable-pitch :foreground ,zenburn-yellow-2 ,@(when zenburn-scale-outline-headlines (list :height zenburn-height-plus-1))))))
...
;;;;; SLIME
   ...
   `(slime-error-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-red)))))
   `(slime-warning-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-orange)))))
   `(slime-style-warning-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-yellow)))))
   `(slime-note-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-green)))))
   `(slime-highlight-face ((,class (:inherit highlight))))
;;;;; SLY
   `(sly-mrepl-output-face ((,class (:foreground ,zenburn-red))))
   `(sly-error-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-red)))))
   `(sly-warning-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-orange)))))
   `(sly-style-warning-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-yellow)))))
   `(sly-note-face ((((supports :underline (:style wave))) (:underline (:style wave :color ,zenburn-green)))))
...
;;;;; sx
   `(sx-custom-button ((,class (:background ,zenburn-fg :foreground ,zenburn-bg-1 :height 0.9))))
   `(sx-question-list-answers ((,class (:foreground ,zenburn-green+3 :height 1.0 :inherit sx-question-list-parent))))
   `(sx-question-mode-accepted ((,class (:foreground ,zenburn-green+3 :height 1.3 :inherit sx-question-mode-title))))
   `(sx-question-mode-content-face ((,class (:inherit highlight))))
   `(sx-question-mode-kbd-tag ((,class (:height 0.9 :weight semi-bold))))
;;;;; tabbar
...
;;;;; tab-bar
   ...
   `(tab-bar-tab ((,class (:foreground ,zenburn-fg :background ,zenburn-bg :weight bold))))
   `(tab-bar-tab-inactive ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+1))))
;;;;; tab-line
   `(tab-line ((,class (:background ,zenburn-bg+1))))
   `(tab-line-tab ((,class (:foreground ,zenburn-fg :background ,zenburn-bg :weight bold))))
   `(tab-line-tab-inactive ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+1))))
   `(tab-line-tab-current ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+1))))
;;;;; term
...
;;;;; window-tool-bar-mode
   `(window-tool-bar-button ((,class (:foreground ,zenburn-fg :background ,zenburn-bg))))
   `(window-tool-bar-button-hover ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+1))))
   `(window-tool-bar-button-disabled ((,class (:foreground ,zenburn-fg :background ,zenburn-bg+3))))
;;;;; xcscope
   ...
   `(cscope-separator-face ((,class (:foreground ,zenburn-red :weight bold :underline t :overline t))))
;;;;; yascroll
...
;;;;; nrepl-client
   `(nrepl-message-colors '(,zenburn-red ,zenburn-orange ,zenburn-yellow ,zenburn-green ,zenburn-green+4 ,zenburn-cyan ,zenburn-blue+1 ,zenburn-magenta))
;;;;; pdf-tools
...
;;;;; vc-annotate
   ...
   `(vc-annotate-color-map '(( 20. . ,zenburn-red-1)
                             ( 40. . ,zenburn-red)
                             ( 60. . ,zenburn-orange)
                             ( 80. . ,zenburn-yellow-2)
