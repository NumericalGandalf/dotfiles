...
(defun helm-company-gandalf-hook ()
  "helm-company gandalf completion hook"
  (interactive)
  (define-key evil-insert-state-local-map (kbd "C-;")
    (lambda ()
      "helm-company gandalf completion hook callback"
      (interactive)
      (evil-emacs-state 1)
      (company-mode 1)
      (helm-company)
...
(defun helm-company-gandalf-init ()
  "Set helm-company gandalf completion hooks"
  (interactive)
  (add-hook 'emacs-lisp-mode-hook 'helm-company-gandalf-hook))
